		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="{{action('CategoryController@decrement', $item->id)}}">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
							{!! Form::label('parentcategory', 'Parent Category', ['class' => 'control-label', 'style' => 'margin-left:15px;color:#000000;margin-bottom:10px;']) !!}
							<div class="col-sm-12">
								{{ Form::select('parentcategory', $parent_categories, null, ['class' => 'form-control', 'placeholder' => 'Select a Parent Category']) }}
							</div>
						</div>
